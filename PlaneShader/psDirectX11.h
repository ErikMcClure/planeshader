...
namespace planeshader {
  ...
  protected:
    ...
    static inline unsigned int BSS_FASTCALL _reverseusage(unsigned int usage, unsigned int misc, unsigned int bind); //reassembles DX11 flags into a generic usage flag
