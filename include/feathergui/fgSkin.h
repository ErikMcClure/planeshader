...
FG_EXTERN size_t fgSkinBase_AddResource(fgSkinBase* self, void* resource);
FG_EXTERN char fgSkinBase_RemoveResource(fgSkinBase* self, FG_UINT resource);
FG_EXTERN void* fgSkinBase_GetResource(const fgSkinBase* self, FG_UINT resource);
...
FG_EXTERN fgSkin* fgSkins_LoadFileUBJSON(fgSkinBase* self, const char* file);
FG_EXTERN fgSkin* fgSkins_LoadUBJSON(fgSkinBase* self, const void* data, FG_UINT length);
FG_EXTERN fgSkin* fgSkins_LoadFileXML(fgSkinBase* self, const char* file);
FG_EXTERN fgSkin* fgSkins_LoadXML(fgSkinBase* self, const char* data, FG_UINT length);
