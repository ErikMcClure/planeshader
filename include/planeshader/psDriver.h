...
namespace planeshader {
  ...
  public:
    ...
    // Draws a polygon
    virtual psBatchObj* DrawPolygon(psShader* shader, const psStateblock* stateblock, const psVec* verts, uint32_t num, psVec3D offset, uint32_t color, psFlag flags)=0;
    ...
    virtual void DrawLines(psBatchObj*& obj, const psLine& line, float Z1, float Z2, uint32_t color)=0;
